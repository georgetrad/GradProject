...
<div class="data_container medium-10 large-10 columns">    
    ...
    <div class="row">
        ...
        <div class="medium-5 large-5 columns">
            <div class="round left_home_title label"><?=NUM_BELOW_STU?></div> <div class=" secondary label"></div>
        </div>
    </div>    
    <div class="row">
        <div class="medium-5 large-5 columns">
        ...
        <div class="medium-5 large-5 columns">
            <div class="round left_home_title label"><?=NUM_STU_WITHOUT_ADV?></div> <div class=" secondary label"></div>
        </div>
    </div>    
    <div class="row">
        <div class="medium-5 large-5 columns">
        ...
        <div class="medium-5 large-5 columns">
            <div class="round left_home_title label"><?=NUM_SUGG_CRS?></div> <div class=" secondary label"></div>
        </div>
    </div>    
    <div class="row">
        <div class="medium-5 large-5 columns">
        ...
        <div class="medium-5 large-5 columns">
            <div class="round left_home_title label"><?=MOST_FAILED_CRS?></div> <div class=" secondary label"></div>
        </div>        
    </div>    
    <div class="row">
        <div class="medium-5 large-5 columns">
